...
from DewmiBot import TIGERS, WOLVES, dispatcher
...
from DewmiBot.modules.helper_funcs.string_handling import split_quotes
from DewmiBot.modules.log_channel import loggable
from DewmiBot.modules.sql import warns_sql as sql
