...
import DewmiBot.modules.sql.feds_sql as sql
from DewmiBot import DRAGONS, EVENT_LOGS, LOGGER, OWNER_ID, TIGERS, WOLVES, dispatcher
...
from DewmiBot.modules.helper_funcs.string_handling import markdown_parser
